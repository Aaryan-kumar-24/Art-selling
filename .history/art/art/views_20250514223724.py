...
customization=custom)
    ...
    # Fetch all commission data to display
    all_commissions = Commission.objects.all().order_by('-id')  # latest first
    return render(request, "home.html", {'data': data, 'all_commissions': all_commissions})
✅ Step 2: Display commissions in home.html
