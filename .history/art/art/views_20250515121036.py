...
customization=custom)
        ...
        data = {'phone1': phone1,'email' :email1, 'medium':medium,'price':price,'image':image,'custom':custom,'phone': phonec,'email' :emailc, 'state':statec,'city':cityc,'address':addressc,'feedback':feedbackc , "artofseller":artofseller , "sellprice":sellprice ,"sellDescription":sellDescription , "d":d , "sellerartwork":sellerartwork, "p":p, "title":selltitle}
        contactdata = Contact(phone=phonec,
email=emailc,
state=statec,
city=cityc,
