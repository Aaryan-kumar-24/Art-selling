...
def data(request):
    ...
    try:
        ...
        data = {'phone': phone1,'email' :email1, 'medium':medium,'price':price,'image':image,'custom':custom,'phone': phone,'email' :email, 'state':state,'city':city,'address':address,'feedback':feedback , "artofseller":artofseller , "sellprice":sellprice ,"sellDescription":sellDescription , "d":d , "sellerartwork":sellerartwork, "p":p, "title":selltitle}
        return render(request,"data.html",data )
    except:
        pass
